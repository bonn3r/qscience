...
$(function() {
    ...
    $('#sidebar').load('/qscience/assets/scr/ensidebar.html', function() {
        /* Após carregar, executa a inicialização do main.js (supondo que main.js define uma função init que pode ser chamada)*/
        ...
        if (typeof window.initSidebar === 'function') {
            ...
            /*Se não tiver uma função explícita, podemos simplesmente disparar um evento para que o main.js reaja, ou reexecutar o código do main.js. Uma solução é mover o código do main.js para uma função e chamá-la aqui.*/
        }
    });
});
